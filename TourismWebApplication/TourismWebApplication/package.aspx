                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="package-item">
                            <div class="overflow-hidden">
                                <img class="img-fluid" src='<%# Eval("ImageUrl") %>' alt="Package Image">
                            </div>
                            ...
                            <div class="text-center p-4">
                                ...
                                <div class="d-flex justify-content-center mb-2">
                                    <a href='PackageDetails.aspx?id=<%# Eval("PackageID") %>' class="btn btn-sm btn-primary px-3 border-end" style="border-radius: 30px 0 0 30px;">Read More</a>
